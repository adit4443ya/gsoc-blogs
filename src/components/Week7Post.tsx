  ...
  return (
    <div className="post-content space-y-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          Below are the five MREs I compiled and ran successfully this week to test the new constructs and fixes via <a href="https://github.com/lfortran/lfortran/pull/7951" className="text-indigo-500 dark:text-indigo-400 hover:underline">#7951</a>
        </p>
